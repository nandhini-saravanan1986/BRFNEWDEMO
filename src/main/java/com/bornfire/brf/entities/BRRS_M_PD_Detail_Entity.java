...
public class BRRS_M_PD_Detail_Entity {
    ...
    public BRRS_M_PD_Detail_Entity(String cUST_ID, String aCCT_NUMBER, String aCCT_NAME, String dATA_TYPE,
    ...
    public BRRS_M_PD_Detail_Entity() {
        super();
    }
