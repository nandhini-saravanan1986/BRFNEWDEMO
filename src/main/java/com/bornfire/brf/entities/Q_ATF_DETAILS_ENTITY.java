...
@Entity
@Table(name="Q_ATF_ACCESS_FIN_DETAIL_TABLE")
public class Q_ATF_DETAILS_ENTITY {
	...
	public Q_ATF_DETAILS_ENTITY() {}
	
	public Q_ATF_DETAILS_ENTITY(String cust_id, String acct_number, String acct_name, String data_type, String row_id,
