...
public class M_LA3_Archival_Detail_Entity {
    ...
    @Column(name = "NO_OF_AC", precision = 24, scale = 2)
    private BigDecimal noOfAc;

    @Column(name = "APPROVED_LIMIT", precision = 24, scale = 2)
    private BigDecimal approvedLimit;

    @Column(name = "CREDIT_LIMIT", precision = 24, scale = 2)
    private BigDecimal creditLimit;

    @Column(name = "AMOUNT_OUTSTANDING", precision = 24, scale = 2)
	...
	public BigDecimal getNoOfAc() {
		return noOfAc;
	}

	public void setNoOfAc(BigDecimal noOfAc) {
		this.noOfAc = noOfAc;
	}
