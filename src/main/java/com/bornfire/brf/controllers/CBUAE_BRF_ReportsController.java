...
import com.bornfire.brf.entities.M_SRWA_12B_Summary_Entity4;
import com.bornfire.brf.entities.M_SRWA_12B_Summary_Entity5;
...
import com.bornfire.brf.services.BRRS_M_SRWA_12C_ReportService;
...
// @RequestMapping(value = "/QBRANCHNETupdateAll", method = { RequestMethod.GET, RequestMethod.POST })
// @ResponseBody
// public ResponseEntity<String> updateQBRANCHNETAllReports(
//         @RequestParam(required = false)
//         @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
//         @RequestParam(required = false) String type,
...
//         // ✅ Normal or RESUB logic
//         if ("RESUB".equalsIgnoreCase(type)) {
//             Q_BRANCHNETservice.QBranchnetUpdate1(request1);
//             Q_BRANCHNETservice.QBranchnetUpdate2(request2);
//             Q_BRANCHNETservice.QBranchnetUpdate3(request3);
//             Q_BRANCHNETservice.QBranchnetUpdate4(request4);
//         // } else if ("ARCHIVAL".equalsIgnoreCase(type)) {
//         //     Q_BRANCHNETservice.updateReportArchival1(request1);
//         //     Q_BRANCHNETservice.updateReportArchival2(request2);
//         //     Q_BRANCHNETservice.updateReportArchival3(request3);
//         //     Q_BRANCHNETservice.updateReportArchival4(request4);
//          } else {
//             Q_BRANCHNETservice.QBranchnetUpdate1(request1);
//             Q_BRANCHNETservice.QBranchnetUpdate2(request2);
//             Q_BRANCHNETservice.QBranchnetUpdate3(request3);
...
// @RequestMapping(value = "/UpdateQ_BRANCHNET_ReSub", method = { RequestMethod.GET, RequestMethod.POST })
// @ResponseBody
// public ResponseEntity<String> updateQBRANCHNETReSub(
//         @RequestParam(required = false)
//         @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
//         @ModelAttribute Q_BRANCHNET_Summary_Entity1 request1,
//         @ModelAttribute Q_BRANCHNET_Summary_Entity2 request2,
...
//         // ✅ Set report date to all 4 entities
//         if (asondate != null) {
//             request1.setReportDate(asondate);
//             request2.setReportDate(asondate);
//             request3.setReportDate(asondate);
...
//         // ✅ Call service method
//         Q_BRANCHNETservice.updateQBRANCHNETReSub(request1, request2, request3, request4);
...
public ResponseEntity<String> updateReportReSub(
    ...
    try {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
		 ...
		 @Autowired
			private com.bornfire.brf.services.BRRS_M_CR_ReportService BRRS_M_CR_ReportService;
			...
			public ResponseEntity<String> updateAllCRReports(
					@RequestParam(required = false) @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
					@ModelAttribute BRRS_M_CR_Summary_Entity request1) {
				try {
					System.out.println("Came to single controller");
					// set date into all 4 entities
					request1.setReport_date(asondate);
			...
			@Autowired
			private com.bornfire.brf.services.BRRS_M_SRWA_12E_ReportService BRRS_M_SRWA_12E_ReportService;
			...
			@ModelAttribute BRRS_M_SRWA_12E_LTV_Summary_Entity request1) {
				try {
					...
					return ResponseEntity.ok("SRWA 12E Reports Updated Successfully");
				} catch (Exception e) {
					e.printStackTrace();
					return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Update Failed: " + e.getMessage());
				}
...
// }
		 ...
		 @Autowired
		 private BRRS_M_DEP3_ReportService MDEP3_service;
		
		 @RequestMapping(value = "/DEP2", method = { RequestMethod.GET, RequestMethod.POST })
		 @ResponseBody
		 public ResponseEntity<String> updateReport(
		     @RequestParam(required = false)
		     @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
		     @ModelAttribute M_DEP3_Manual_Summary_Entity2 request,
		     HttpServletRequest req) {
		     try {
		         System.out.println("came to First controller");
		         SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
		         ...
		         // ✅ set the asondate into entity
		         request.setReport_date(asondate);
		         MDEP3_service.updateReport2(request);
		         return ResponseEntity.ok("Updated Successfully");
		     } catch (Exception e) {
		         e.printStackTrace();
		         return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
		 ...
		 @RequestMapping(value = "/DEP3", method = { RequestMethod.GET, RequestMethod.POST })
		 @ResponseBody
		 public ResponseEntity<String> updateReport2(
		     @RequestParam(required = false)
		     @DateTimeFormat(pattern = "dd/MM/yyyy") Date asondate,
		     @ModelAttribute M_DEP3_Manual_Summary_Entity3 request,
		     HttpServletRequest req) {
		     try {
		         System.out.println("came to Second controller");
		         SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
		         ...
		         // ✅ set the asondate into entity
		         request.setREPORT_DATE(asondate);
		         MDEP3_service.updateReport3(request);
		         return ResponseEntity.ok("Updated Successfully");
		     } catch (Exception e) {
		         e.printStackTrace();
		         return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
