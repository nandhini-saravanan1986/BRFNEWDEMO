...
import com.bornfire.brf.entities.BRRS_M_OR1_Archival_Detail_Repo;
import com.bornfire.brf.entities.BRRS_M_OR1_Archival_Summary_Repo;
...
import com.bornfire.brf.entities.M_OR1_Archival_Detail_Entity;
import com.bornfire.brf.entities.M_OR1_Archival_Summary_Entity;
...
T1Dt1 = M_OR1_Archival_Detail_Repo.GetDataByRowIdAndColumnId(rowId, columnId, parsedDate, version);
} else {
...
if (rowId != null && columnId != null) {
T1Dt1 = M_OR1_DETAIL_Repo.getdatabydateListrow(parsedDate, columnId, rowId);
} else {
...
return mv;
	...
	public byte[] getM_OR1Excel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype) throws Exception {
	...
	public byte[] M_OR1DetailExcel(String filename, String fromdate, String todate) {
	    try {
	        ...
	        if (reportData != null && !reportData.isEmpty()) {
	            ...
	            logger.info("No data found for M_OR1 — only header will be written.");
	        }
	        ...
	        logger.error("Error generating M_OR1 Excel", e);
	        return new byte[0];
	    }
	}
...
XSSFWorkbook workbook = new XSSFWorkbook();
XSSFSheet sheet = workbook.createSheet("M_OR1Detail");
...
//Get data
Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
List<M_OR1_Archival_Detail_Entity> reportData = M_OR1_Archival_Detail_Repo
