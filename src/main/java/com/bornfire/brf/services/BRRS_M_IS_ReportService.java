...
private static final Logger logger = LoggerFactory.getLogger(BRRS_M_IS_ReportService.class);
	...
	@Autowired
	BRRS_M_IS_Detail_Repo M_IS_DETAIL_Repo2;
	...
	public ModelAndView getM_ISView(String reportId, String fromdate, String todate, String currency, String dtltype,
		...
		List<M_IS_Summary_Entity2> T2Master = new ArrayList<M_IS_Summary_Entity2>();
		...
		try {
			...
			//T1Master = hs.createQuery("from  BRF1_REPORT_ENTITY a where a.report_date = ?1 ", BRF1_REPORT_ENTITY.class)
			 ...
			 T2Master=M_IS_Summary_Repo2.getdatabydateList(dateformat.parse(todate));
	...
	public ModelAndView getM_IScurrentDtl(String reportId, String fromdate, String todate, String currency,
		...
		Session hs = sessionFactory.getCurrentSession();
		List<M_IS_Detail_Entity> T1Dt1 = new ArrayList<M_IS_Detail_Entity>();
		...
		try {
	        ...
	        if (rowId != null && columnId != null) { 
	        	...
	        	T1Dt1=M_IS_DETAIL_Repo.getdatabydateListrow(dateformat.parse(todate),columnId,rowId);

	        	
	        } else {
	        		
				T1Dt1 = M_IS_DETAIL_Repo.getdatabydateList(d1,currentPage,pageSize);
				totalPages=M_IS_DETAIL_Repo.getdatacount(dateformat.parse(todate));
...
public byte[] BRRS_M_ISExcel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype) throws Exception {
...
public byte[] BRRS_M_ISDetailExcel(String filename, String fromdate, String todate) {
    try {
        logger.info("Generating Excel for BRRS_M_IS Details...");
        ...
        logger.error("Error generating BRRS_M_IS Excel", e);
        return new byte[0];
    }
}
