...
//getDetailExcelARCHIVAL
	...
	public byte[] getDetailExcelARCHIVAL(String filename, String fromdate, String todate, String currency,
		...
		try {
			...
			List<M_SIR_Archival_Detail_Entity> reportData = M_SIR_Archival_Detail_Repo.getdatabydateList(parsedToDate,
					version);
	...
	public byte[] getM_SIRDetailExcel(String filename, String fromdate, String todate, String currency, String dtltype,String type, String version) {
...
return out.toByteArray();
	...
	public byte[] getM_SIRExcel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype,String type,String version) throws Exception {
		...
		if ("ARCHIVAL".equalsIgnoreCase(type) && version != null && !version.trim().isEmpty()) {
			...
			return getExcelM_SIRARCHIVAL(filename, reportId, fromdate, todate, currency, dtltype, type, version);
		}
