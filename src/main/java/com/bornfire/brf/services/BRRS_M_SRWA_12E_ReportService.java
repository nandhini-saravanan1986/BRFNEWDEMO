...
import com.bornfire.brf.entities.BRRS_M_SRWA_12E_LTV_Detail_Repo;
import com.bornfire.brf.entities.BRRS_M_SRWA_12E_LTV_Summary_Entity;
import com.bornfire.brf.entities.BRRS_M_SRWA_12E_LTV_Summary_Repo;
import com.bornfire.brf.entities.BRRS_M_SRWA_12E_LTV_Archival_Detail_Repo;
import com.bornfire.brf.entities.BRRS_M_SRWA_12E_LTV_Archival_Summary_Entity;
import com.bornfire.brf.entities.BRRS_M_SRWA_12E_LTV_Archival_Summary_Repo;
...
public class BRRS_M_SRWA_12E_ReportService {
	...
	public ModelAndView getM_SRWA_12EView(String reportId, String fromdate, String todate, String currency, String dtltype,
		...
		if (type.equals("ARCHIVAL") & version != null) {
			List<BRRS_M_SRWA_12E_LTV_Archival_Summary_Entity> T1Master = new ArrayList<BRRS_M_SRWA_12E_LTV_Archival_Summary_Entity>();
			try {
				...
				T1Master = BRRS_M_SRWA_12E_LTV_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
			...
			List<BRRS_M_SRWA_12E_LTV_Summary_Entity> T1Master = new ArrayList<BRRS_M_SRWA_12E_LTV_Summary_Entity>();

			try {
				Date d1 = dateformat.parse(todate);

				T1Master = BRRS_M_SRWA_12E_LTV_Summary_Repo.getdatabydateList(dateformat.parse(todate));
...
//	custom implementation for archival
	...
	public byte[] BRRS_M_SRWA_12EExcel(String filename, String reportId, String fromdate, String todate, String currency,
		...
		// Fetch data
		List<BRRS_M_SRWA_12E_LTV_Summary_Entity> dataList = BRRS_M_SRWA_12E_LTV_Summary_Repo.getdatabydateList(dateformat.parse(todate));
...
// --- Style Definitions ---
	...
	public void updateReport(BRRS_M_SRWA_12E_LTV_Summary_Entity updatedEntity) {
		...
		BRRS_M_SRWA_12E_LTV_Summary_Entity existing = BRRS_M_SRWA_12E_LTV_Summary_Repo.findById(updatedEntity.getReport_date()).orElseThrow(
