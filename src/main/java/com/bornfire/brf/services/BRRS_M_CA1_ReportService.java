...
import com.bornfire.brf.entities.M_CA1_Detail_Entity;
import com.bornfire.brf.entities.BRRS_M_CA1_Detail_Repo;
import com.bornfire.brf.entities.M_CA1_Summary_Entity;
import com.bornfire.brf.entities.BRRS_M_CA1_Summary_Repo;
...
private static final Logger logger = LoggerFactory.getLogger(BRRS_M_CA1_ReportService.class);
	...
	public ModelAndView getBRRS_M_CA1View(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
	...
	public ModelAndView getBRRS_M_CA1currentDtl(
...
public byte[] getBRRS_M_CA1Excel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype) throws Exception {
	...
	public byte[] geBRRS_M_CA1DetailExcel(String filename, String fromdate, String todate) {
	    try {
