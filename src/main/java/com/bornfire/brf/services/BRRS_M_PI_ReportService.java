...
private static final Logger logger = LoggerFactory.getLogger(BRRS_M_PI_ReportService.class);
    ...
    @Autowired
private BRRS_M_PI_Summary_Repo BRRS_M_PI_Summary_Repo;

@Autowired
private BRRS_M_PI_Detail_Repo BRRS_M_PI_detail_Repo;
	
	
	SimpleDateFormat dateformat = new SimpleDateFormat("dd-MMM-yyyy");
	public ModelAndView getBRRS_M_PIView(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
	...
	public ModelAndView getBRRS_M_PIcurrentDtl(
	    ...
	    ModelAndView mv = new ModelAndView();
	    List<M_PI_Detail_Entity> T1Dt1 = new ArrayList<>();
	    ...
	    try {
	        ...
	        if (rowId != null && columnId != null) {
	            T1Dt1 = BRRS_M_PI_detail_Repo.GetDataByRowIdAndColumnId(rowId, columnId);
	        } else {
	            T1Dt1 = BRRS_M_PI_detail_Repo.getdatabydateList(d1,currentPage,pageSize);
				totalPages=BRRS_M_PI_detail_Repo.getdatacount(dateformat.parse(todate));
	...
	public byte[] getBRRS_M_PIExcel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype) throws Exception {
	...
	public byte[] getBRRS_M_PIDetailExcel(String filename, String fromdate, String todate) {
	    try {
	        ...
	        List<M_PI_Detail_Entity> reportData = BRRS_M_PI_detail_Repo.getdatabydateList(parsedToDate);
	        ...
	        if (reportData != null && !reportData.isEmpty()) {
	            ...
	            logger.info("No data found for BRRS_M_PIDetails — only header will be written.");
	        }
