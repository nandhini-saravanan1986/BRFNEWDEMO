...
//			 --- End of Style Definitions ---
			...
			private void populateEntity1Data(Sheet sheet, M_CA5_Summary_Entity1 record, CellStyle textStyle, CellStyle numberStyle, CellStyle dateStyle) {					
				...
				if (record.getR14_issuance_date() != null) {
				    cell4.setCellValue(record.getR14_issuance_date());
				...
				if (record.getR14_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR14_contractual_maturity_date());
				...
				if (record.getR14_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR14_effective_maturity_date_if_date());
				...
				if (record.getR15_issuance_date() != null) {
				    cell4.setCellValue(record.getR15_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR15_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR15_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR15_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR15_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR16_issuance_date() != null) {
				    cell4.setCellValue(record.getR16_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR16_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR16_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR16_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR16_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR17_issuance_date() != null) {
				    cell4.setCellValue(record.getR17_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR17_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR17_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR17_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR17_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR18_issuance_date() != null) {
				    cell4.setCellValue(record.getR18_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR18_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR18_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR18_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR18_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR19_issuance_date() != null) {
				    cell4.setCellValue(record.getR19_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR19_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR19_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR19_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR19_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR20_issuance_date() != null) {
				    cell4.setCellValue(record.getR20_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR20_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR20_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR20_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR20_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR21_issuance_date() != null) {
				    cell4.setCellValue(record.getR21_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR21_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR21_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR21_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR21_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR22_issuance_date() != null) {
				    cell4.setCellValue(record.getR22_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR22_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR22_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR22_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR22_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR23_issuance_date() != null) {
				    cell4.setCellValue(record.getR23_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR23_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR23_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR23_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR23_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR24_issuance_date() != null) {
				    cell4.setCellValue(record.getR24_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR24_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR24_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR24_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR24_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR25_issuance_date() != null) {
				    cell4.setCellValue(record.getR25_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR25_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR25_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR25_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR25_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR26_issuance_date() != null) {
				    cell4.setCellValue(record.getR26_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR26_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR26_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR26_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR26_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR27_issuance_date() != null) {
				    cell4.setCellValue(record.getR27_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR27_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR27_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR27_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR27_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR28_issuing_entity_if_issued_throughan_spv() != null) {
				    cell3.setCellValue(record.getR28_issuing_entity_if_issued_throughan_spv());
				    cell3.setCellStyle(textStyle);
				} else {
				    cell3.setCellValue("");
				    cell3.setCellStyle(textStyle);
				...
				if (record.getR28_issuance_date() != null) {
				    cell4.setCellValue(record.getR28_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR28_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR28_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR28_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR28_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR35_issuance_date() != null) {
				    cell4.setCellValue(record.getR35_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR35_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR35_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR35_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR35_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR36_issuance_date() != null) {
				    cell4.setCellValue(record.getR36_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR36_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR36_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR36_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR36_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR37_issuance_date() != null) {
				    cell4.setCellValue(record.getR37_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR37_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR37_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR37_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR37_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR38_issuance_date() != null) {
				    cell4.setCellValue(record.getR38_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR38_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR38_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR38_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR38_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR39_issuance_date() != null) {
				    cell4.setCellValue(record.getR39_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR39_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR39_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR39_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR39_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR40_issuance_date() != null) {
				    cell4.setCellValue(record.getR40_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR40_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR40_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR40_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR40_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR41_issuance_date() != null) {
				    cell4.setCellValue(record.getR41_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR41_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR41_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR41_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR41_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR42_issuance_date() != null) {
				    cell4.setCellValue(record.getR42_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR42_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR42_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR42_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR42_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR43_issuance_date() != null) {
				    cell4.setCellValue(record.getR43_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR43_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR43_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR43_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR43_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR44_issuance_date() != null) {
				    cell4.setCellValue(record.getR44_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR44_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR44_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR44_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR44_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR45_issuance_date() != null) {
				    cell4.setCellValue(record.getR45_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR45_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR45_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR45_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR45_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR46_issuance_date() != null) {
				    cell4.setCellValue(record.getR46_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR46_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR46_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR46_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR46_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR47_issuance_date() != null) {
				    cell4.setCellValue(record.getR47_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR47_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR47_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR47_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR47_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR48_issuance_date() != null) {
				    cell4.setCellValue(record.getR48_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR48_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR48_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR48_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR48_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR49_issuance_date() != null) {
				    cell4.setCellValue(record.getR49_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR49_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR49_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR49_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR49_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR50_issuance_date() != null) {
				    cell4.setCellValue(record.getR50_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR50_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR50_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR50_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR50_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR51_issuance_date() != null) {
				    cell4.setCellValue(record.getR51_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR51_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR51_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR51_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR51_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR52_issuance_date() != null) {
				    cell4.setCellValue(record.getR52_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR52_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR52_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR52_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR52_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR53_issuance_date() != null) {
				    cell4.setCellValue(record.getR53_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR53_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR53_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR53_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR53_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR54_issuance_date() != null) {
				    cell4.setCellValue(record.getR54_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR54_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR54_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR54_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR54_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR55_issuance_date() != null) {
				    cell4.setCellValue(record.getR55_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR55_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR55_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR55_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR55_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR56_issuance_date() != null) {
				    cell4.setCellValue(record.getR56_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR56_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR56_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR56_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR56_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR57_issuance_date() != null) {
				    cell4.setCellValue(record.getR57_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR57_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR57_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR57_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR57_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR58_issuance_date() != null) {
				    cell4.setCellValue(record.getR58_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR58_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR58_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR58_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR58_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR59_issuance_date() != null) {
				    cell4.setCellValue(record.getR59_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR59_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR59_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR59_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR59_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR60_issuance_date() != null) {
				    cell4.setCellValue(record.getR60_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR60_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR60_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR60_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR60_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR61_issuance_date() != null) {
				    cell4.setCellValue(record.getR61_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR61_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR61_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR61_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR61_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR62_issuance_date() != null) {
				    cell4.setCellValue(record.getR62_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR62_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR62_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR62_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR62_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR63_issuance_date() != null) {
				    cell4.setCellValue(record.getR63_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR63_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR63_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR63_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR63_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR64_issuance_date() != null) {
				    cell4.setCellValue(record.getR64_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR64_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR64_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR64_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR64_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR65_issuance_date() != null) {
				    cell4.setCellValue(record.getR65_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR65_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR65_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR65_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR65_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR66_issuance_date() != null) {
				    cell4.setCellValue(record.getR66_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR66_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR66_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR66_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR66_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR67_issuance_date() != null) {
				    cell4.setCellValue(record.getR67_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR67_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR67_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR67_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR67_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR68_issuance_date() != null) {
				    cell4.setCellValue(record.getR68_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR68_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR68_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR68_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR68_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR69_issuance_date() != null) {
				    cell4.setCellValue(record.getR69_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR69_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR69_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR69_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR69_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR70_issuance_date() != null) {
				    cell4.setCellValue(record.getR70_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR70_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR70_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR70_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR70_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR71_issuance_date() != null) {
				    cell4.setCellValue(record.getR71_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR71_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR71_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR71_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR71_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR72_issuance_date() != null) {
				    cell4.setCellValue(record.getR72_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR72_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR72_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR72_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR72_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR73_issuance_date() != null) {
				    cell4.setCellValue(record.getR73_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR73_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR73_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR73_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR73_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR74_issuance_date() != null) {
				    cell4.setCellValue(record.getR74_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR74_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR74_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR74_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR74_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR75_issuance_date() != null) {
				    cell4.setCellValue(record.getR75_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR75_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR75_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR75_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR75_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR76_issuance_date() != null) {
				    cell4.setCellValue(record.getR76_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR76_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR76_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR76_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR76_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR77_issuance_date() != null) {
				    cell4.setCellValue(record.getR77_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR77_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR77_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR77_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR77_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR78_issuance_date() != null) {
				    cell4.setCellValue(record.getR78_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR78_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR78_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR78_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR78_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR79_issuance_date() != null) {
				    cell4.setCellValue(record.getR79_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR79_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR79_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR79_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR79_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR80_issuance_date() != null) {
				    cell4.setCellValue(record.getR80_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR80_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR80_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR80_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR80_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR81_issuance_date() != null) {
				    cell4.setCellValue(record.getR81_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR81_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR81_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR81_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR81_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR82_issuance_date() != null) {
				    cell4.setCellValue(record.getR82_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR82_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR82_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR82_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR82_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR83_issuance_date() != null) {
				    cell4.setCellValue(record.getR83_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR83_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR83_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR83_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR83_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR84_issuance_date() != null) {
				    cell4.setCellValue(record.getR84_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR84_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR84_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR84_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR84_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR85_issuance_date() != null) {
				    cell4.setCellValue(record.getR85_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR85_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR85_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR85_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR85_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR86_issuance_date() != null) {
				    cell4.setCellValue(record.getR86_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR86_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR86_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR86_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR86_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR87_issuance_date() != null) {
				    cell4.setCellValue(record.getR87_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR87_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR87_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR87_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR87_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR88_issuance_date() != null) {
				    cell4.setCellValue(record.getR88_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR88_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR88_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR88_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR88_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR89_issuance_date() != null) {
				    cell4.setCellValue(record.getR89_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR89_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR89_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR89_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR89_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR90_issuance_date() != null) {
				    cell4.setCellValue(record.getR90_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR90_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR90_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR90_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR90_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR91_issuance_date() != null) {
				    cell4.setCellValue(record.getR91_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR91_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR91_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR91_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR91_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR92_issuance_date() != null) {
				    cell4.setCellValue(record.getR92_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR92_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR92_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR92_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR92_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR93_issuance_date() != null) {
				    cell4.setCellValue(record.getR93_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR93_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR93_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR93_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR93_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR94_issuance_date() != null) {
				    cell4.setCellValue(record.getR94_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR94_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR94_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR94_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR94_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR95_issuance_date() != null) {
				    cell4.setCellValue(record.getR95_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR95_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR95_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR95_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR95_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR96_issuance_date() != null) {
				    cell4.setCellValue(record.getR96_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR96_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR96_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR96_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR96_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR97_issuance_date() != null) {
				    cell4.setCellValue(record.getR97_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR97_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR97_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR97_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR97_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR98_issuance_date() != null) {
				    cell4.setCellValue(record.getR98_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR98_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR98_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR98_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR98_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR99_issuance_date() != null) {
				    cell4.setCellValue(record.getR99_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR99_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR99_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR99_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR99_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
				...
				if (record.getR100_issuance_date() != null) {
				    cell4.setCellValue(record.getR100_issuance_date());
				    cell4.setCellStyle(dateStyle);
				} else {
				    cell4.setCellValue("");
				    cell4.setCellStyle(textStyle);
				...
				if (record.getR100_contractual_maturity_date() != null) {
				    cell5.setCellValue(record.getR100_contractual_maturity_date());
				    cell5.setCellStyle(dateStyle);
				} else {
				    cell5.setCellValue("");
				    cell5.setCellStyle(textStyle);
				...
				if (record.getR100_effective_maturity_date_if_date() != null) {
				    cell6.setCellValue(record.getR100_effective_maturity_date_if_date());
				    cell6.setCellStyle(dateStyle);
				} else {
				    cell6.setCellValue("");
				    cell6.setCellStyle(textStyle);
					...
					CellStyle originalStyle;
					       ...
					       // Column C
					        ...
					        if (record1.getR101_issuance_date() != null) {
					            cell4.setCellValue(record1.getR101_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR101_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR101_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR101_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR101_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR102_issuance_date() != null) {
					            cell4.setCellValue(record1.getR102_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR102_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR102_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR102_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR102_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR103_issuance_date() != null) {
					            cell4.setCellValue(record1.getR103_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR103_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR103_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR103_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR103_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR104_issuance_date() != null) {
					            cell4.setCellValue(record1.getR104_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR104_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR104_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR104_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR104_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR105_issuance_date() != null) {
					            cell4.setCellValue(record1.getR105_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR105_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR105_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR105_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR105_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR106_issuance_date() != null) {
					            cell4.setCellValue(record1.getR106_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR106_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR106_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR106_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR106_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR107_issuance_date() != null) {
					            cell4.setCellValue(record1.getR107_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR107_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR107_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR107_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR107_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR108_issuance_date() != null) {
					            cell4.setCellValue(record1.getR108_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR108_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR108_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR108_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR108_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR109_issuance_date() != null) {
					            cell4.setCellValue(record1.getR109_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR109_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR109_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR109_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR109_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR110_issuance_date() != null) {
					            cell4.setCellValue(record1.getR110_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR110_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR110_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR110_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR110_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR111_issuance_date() != null) {
					            cell4.setCellValue(record1.getR111_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR111_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR111_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR111_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR111_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR112_issuance_date() != null) {
					            cell4.setCellValue(record1.getR112_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR112_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR112_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR112_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR112_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR113_issuance_date() != null) {
					            cell4.setCellValue(record1.getR113_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR113_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR113_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR113_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR113_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR114_issuance_date() != null) {
					            cell4.setCellValue(record1.getR114_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR114_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR114_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR114_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR114_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR115_issuance_date() != null) {
					            cell4.setCellValue(record1.getR115_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR115_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR115_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR115_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR115_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR116_issuance_date() != null) {
					            cell4.setCellValue(record1.getR116_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR116_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR116_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR116_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR116_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR117_issuance_date() != null) {
					            cell4.setCellValue(record1.getR117_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR117_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR117_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR117_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR117_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR118_issuance_date() != null) {
					            cell4.setCellValue(record1.getR118_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR118_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR118_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR118_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR118_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR119_issuance_date() != null) {
					            cell4.setCellValue(record1.getR119_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR119_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR119_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR119_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR119_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR120_issuance_date() != null) {
					            cell4.setCellValue(record1.getR120_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR120_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR120_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR120_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR120_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR121_issuance_date() != null) {
					            cell4.setCellValue(record1.getR121_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR121_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR121_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR121_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR121_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR122_issuance_date() != null) {
					            cell4.setCellValue(record1.getR122_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR122_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR122_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR122_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR122_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR123_issuance_date() != null) {
					            cell4.setCellValue(record1.getR123_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR123_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR123_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR123_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR123_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR124_issuance_date() != null) {
					            cell4.setCellValue(record1.getR124_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR124_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR124_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR124_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR124_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR125_issuance_date() != null) {
					            cell4.setCellValue(record1.getR125_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR125_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR125_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR125_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR125_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR126_issuance_date() != null) {
					            cell4.setCellValue(record1.getR126_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR126_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR126_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR126_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR126_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR127_issuance_date() != null) {
					            cell4.setCellValue(record1.getR127_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR127_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR127_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR127_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR127_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR128_issuance_date() != null) {
					            cell4.setCellValue(record1.getR128_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR128_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR128_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR128_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR128_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR129_issuance_date() != null) {
					            cell4.setCellValue(record1.getR129_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR129_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR129_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR129_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR129_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR130_issuance_date() != null) {
					            cell4.setCellValue(record1.getR130_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR130_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR130_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR130_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR130_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR131_issuance_date() != null) {
					            cell4.setCellValue(record1.getR131_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR131_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR131_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR131_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR131_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR132_issuance_date() != null) {
					            cell4.setCellValue(record1.getR132_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR132_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR132_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR132_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR132_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR133_issuance_date() != null) {
					            cell4.setCellValue(record1.getR133_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR133_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR133_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR133_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR133_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR134_issuance_date() != null) {
					            cell4.setCellValue(record1.getR134_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR134_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR134_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR134_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR134_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR135_issuance_date() != null) {
					            cell4.setCellValue(record1.getR135_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR135_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR135_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR135_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR135_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR136_issuance_date() != null) {
					            cell4.setCellValue(record1.getR136_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR136_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR136_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR136_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR136_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR137_issuance_date() != null) {
					            cell4.setCellValue(record1.getR137_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR137_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR137_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR137_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR137_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR138_issuance_date() != null) {
					            cell4.setCellValue(record1.getR138_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR138_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR138_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR138_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR138_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR139_issuance_date() != null) {
					            cell4.setCellValue(record1.getR139_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR139_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR139_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR139_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR139_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR140_issuance_date() != null) {
					            cell4.setCellValue(record1.getR140_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR140_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR140_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR140_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR140_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR141_issuance_date() != null) {
					            cell4.setCellValue(record1.getR141_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR141_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR141_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR141_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR141_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR142_issuance_date() != null) {
					            cell4.setCellValue(record1.getR142_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR142_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR142_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR142_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR142_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR143_issuance_date() != null) {
					            cell4.setCellValue(record1.getR143_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR143_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR143_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR143_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR143_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR144_issuance_date() != null) {
					            cell4.setCellValue(record1.getR144_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR144_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR144_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR144_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR144_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR145_issuance_date() != null) {
					            cell4.setCellValue(record1.getR145_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR145_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR145_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR145_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR145_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR146_issuance_date() != null) {
					            cell4.setCellValue(record1.getR146_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR146_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR146_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR146_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR146_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR147_issuance_date() != null) {
					            cell4.setCellValue(record1.getR147_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR147_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR147_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR147_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR147_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR148_issuance_date() != null) {
					            cell4.setCellValue(record1.getR148_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR148_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR148_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR148_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR148_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR149_issuance_date() != null) {
					            cell4.setCellValue(record1.getR149_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR149_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR149_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR149_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR149_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR150_issuing_entity_if_issued_throughan_spv() != null) {
					            cell3.setCellValue(record1.getR150_issuing_entity_if_issued_throughan_spv());
					            cell3.setCellStyle(textStyle);
					        } else {
					            cell3.setCellValue("");
					            cell3.setCellStyle(textStyle);
					        ...
					        if (record1.getR150_issuance_date() != null) {
					            cell4.setCellValue(record1.getR150_issuance_date());
					            cell4.setCellStyle(dateStyle);
					        } else {
					            cell4.setCellValue("");
					            cell4.setCellStyle(textStyle);
					        ...
					        if (record1.getR150_contractual_maturity_date() != null) {
					            cell5.setCellValue(record1.getR150_contractual_maturity_date());
					            cell5.setCellStyle(dateStyle);
					        } else {
					            cell5.setCellValue("");
					            cell5.setCellStyle(textStyle);
					        ...
					        if (record1.getR150_effective_maturity_date_if_date() != null) {
					            cell6.setCellValue(record1.getR150_effective_maturity_date_if_date());
					            cell6.setCellStyle(dateStyle);
					        } else {
					            cell6.setCellValue("");
					            cell6.setCellStyle(textStyle);
					        ...
					        if (record1.getR150_amount() != null) {
					            cell7.setCellValue(record1.getR150_amount().doubleValue());
					            cell7.setCellStyle(numberStyle);
					        } else {
					            cell7.setCellValue("");
					            cell7.setCellStyle(textStyle);
					        ...
					        if (record1.getR150_amount_derecognised_p000() != null) {
					            cell8.setCellValue(record1.getR150_amount_derecognised_p000().doubleValue());
					            cell8.setCellStyle(numberStyle);
					        } else {
					            cell8.setCellValue("");
					            cell8.setCellStyle(textStyle);
